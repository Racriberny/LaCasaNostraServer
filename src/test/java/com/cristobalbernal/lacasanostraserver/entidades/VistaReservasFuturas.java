...
public class VistaReservasFuturas {
    ...
    public boolean equals(Object o) {
        ...
        return usuarioId == that.usuarioId && Objects.equals(cantidad, that.cantidad) && Objects.equals(fecha, that.fecha) && Objects.equals(hora, that.hora);
    }

    @Override
    public int hashCode() {
        return Objects.hash(cantidad, usuarioId, fecha, hora);
    }
}
